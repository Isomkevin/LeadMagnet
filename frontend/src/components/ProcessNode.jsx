    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <motion.div
          ...
          className={`
            relative w-48 h-48 rounded-3xl shadow-lg flex flex-col items-center justify-center
        ...
        >
          ...
          >
            {isProcessing ? (
              ...
              <Icon className={`w-8 h-8 ${isCompleted || isActive ? 'text-white' : 'text-gray-500'}`} />
            )}
          </motion.div>
